# synapsid_EQ
Code, data, and phylogenetic tree used for a project on the synapsid encephalization, published in Benoit et al. (2026, *Scientific Reports*).

Main dataset and script for this project includes:
- 'Script_Benoitetal_2026.Rmd': Main R script for the project, in Markdown format
- 'maindataNew.csv': Main dataset for macroevolutionary analyses of encephalization quotient (EQ), in CSV format
- 'CalibratedTreeNew.nex': Calibrated tree used in macroevolutionary analyses of EQ, in NEXUS format
